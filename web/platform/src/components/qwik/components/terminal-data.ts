...
export const terminalTabs: TerminalTab[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "", delay: 300 },
      { text: "Generating.. (8s · ↑ 2.1k tokens · thought for 3s)", delay: 400, instant: true },
      { text: "", delay: 300 },
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "", delay: 300 },
      { text: "Generating.. (6s · ↑ 1.8k tokens · thought for 2s)", delay: 400, instant: true },
      { text: "", delay: 300 },
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "", delay: 300 },
      { text: "Generating.. (11s · ↑ 2.5k tokens · thought for 5s)", delay: 400, instant: true },
      { text: "", delay: 300 },
