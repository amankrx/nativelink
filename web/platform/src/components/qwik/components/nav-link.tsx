  ...
  ({ pathName, activeClass, ...props }: NavLinkProps) => {
    ...
    return (
      <li class="relative flex flex-col justify-center items-center">
        <a
          {...props}
          class={`${props.class || ""} ${isActive ? activeClass : ""} px-3 py-2 min-h-[44px] flex items-center justify-center transition-colors duration-200 hover:text-[rgb(40,40,40)] text-sm`}
        >
          <Slot />
        </a>
      </li>
